...
import (
	...
	"github.com/bigzoro/my_simplechain/accounts/external"
	"github.com/bigzoro/my_simplechain/cmd/utils"
	"github.com/bigzoro/my_simplechain/common"
	"github.com/bigzoro/my_simplechain/contracts/checkpointoracle"
...
func newClient(ctx *cli.Context) *ethclient.Client {
	client, err := ethclient.Dial(ctx.GlobalString(nodeURLFlag.Name), "", "", nil)
	if err != nil {
...
func newClefSigner(ctx *cli.Context) *bind.TransactOpts {
	clef, err := external.NewExternalSigner(ctx.String(clefURLFlag.Name), "", "", nil)
	if err != nil {
