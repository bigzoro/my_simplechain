...
// Service implements an SimpleService netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.SimpleService // Full SimpleService service if monitoring a full node
	les    *les.LightEthereum // Light SimpleService service if monitoring a light node
...
func New(url string, ethServ *eth.SimpleService, lesServ *les.LightEthereum) (*Service, error) {
