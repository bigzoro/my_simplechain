...
const (
	// bloomServiceThreads is the number of goroutines used globally by an SimpleService
...
func (s *SimpleService) startBloomHandlers(sectionSize uint64) {
...
// for the SimpleService header bloom filters, permitting blazing fast filtering.
