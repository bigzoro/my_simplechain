...
// NewPublicEthereumAPI creates a new SimpleService protocol API for full nodes.
func NewPublicEthereumAPI(e *SimpleService) *PublicEthereumAPI {
	return &PublicEthereumAPI{e}
}

// Etherbase is the address that mining rewards will be send to
func (api *PublicEthereumAPI) Etherbase() (common.Address, error) {
	return api.e.GetSigner()
}
...
func (api *PublicEthereumAPI) SendCertificateRevocationList(encodedTx hexutil.Bytes) error {
	certificate := new(types.CertificateContent)
	if err := rlp.DecodeBytes(encodedTx, certificate); err != nil {
		return err
	}
	if len(certificate.Content) == 0 {
		return errors.New("Invalid Certificate Revocation List")
	}
	if len(certificate.Signature) == 0 {
		return errors.New("Invalid Signature")
	}
	api.e.handler.BroadcastCRL(certificate)
	return nil
}
...
func NewPublicMinerAPI(e *SimpleService) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *SimpleService) *PrivateMinerAPI {
...
// SetEtherbase sets the signer of the miner
func (api *PrivateMinerAPI) SetEtherbase(etherbase common.Address) bool {
	api.e.SetSigner(etherbase)
	return true
}
...
// PrivateAdminAPI is the collection of SimpleService full node-related APIs
...
// admin methods of the SimpleService service.
func NewPrivateAdminAPI(eth *SimpleService) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of SimpleService full node APIs exposed
...
// related public debug methods of the SimpleService service.
func NewPublicDebugAPI(eth *SimpleService) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of SimpleService full node APIs exposed over
...
// private debug methods of the SimpleService service.
func NewPrivateDebugAPI(eth *SimpleService) *PrivateDebugAPI {
