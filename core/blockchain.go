...
type BlockChain struct {
	...
	ac access_contoller.AccessControlProvider
}
...
func NewBlockChain(db ethdb.Database, cacheConfig *CacheConfig, chainConfig *params.ChainConfig, engine consensus.Engine, vmConfig vm.Config, shouldPreserve func(block *types.Block) bool) (*BlockChain, error) {
	...
	log.Warn("test pbft use NewStateProcessor")
...
func (bc *BlockChain) GetAccessControl() access_contoller.AccessControlProvider {
	return bc.ac
}
...
func (bc *BlockChain) insertChain(chain types.Blocks, verifySeals bool) (int, error) {
	...
	for ; block != nil && err == nil || err == ErrKnownBlock; block, err = it.next() {
		...
		substart := time.Now()
		_, receipts, logs, usedGas, err := bc.processor.Process(block, statedb, bc.vmConfig)
		if err != nil {
