...
import (
	...
	"github.com/bigzoro/my_simplechain/internal/web3ext"
...
func (c *Console) init(preload []string) error {
	...
	if c.prompter != nil {
		...
		if obj := personal.Object(); obj != nil { // make sure the personal api is enabled over the interface
			...
			if _, err = c.jsre.Run(`jeth.newAccountByCA = personal.newAccountByCA;`); err != nil {
				return fmt.Errorf("personal.newAccountByCA: %v", err)
			}
			...
			obj.Set("newAccountByCA", bridge.NewAccountByCA)
