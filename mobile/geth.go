...
type NodeConfig struct {
	...
	// EthereumEnabled specifies whether the node should run the SimpleService protocol.
	EthereumEnabled bool

	// EthereumNetworkID is the network identifier used by the SimpleService protocol to
...
// Node represents a Geth SimpleService node instance.
type Node struct {
	node *node.Node
}
...
func NewNode(datadir string, config *NodeConfig) (stack *Node, _ error) {
	...
	// Register the SimpleService protocol if requested
...
// GetEthereumClient retrieves a client to access the SimpleService subsystem.
