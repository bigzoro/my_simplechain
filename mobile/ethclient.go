...
func NewEthereumClient(rawurl string, certFile string, keyFile string, certFiles []string) (client *EthereumClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl, certFile, keyFile, certFiles)
