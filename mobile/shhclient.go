...
func NewWhisperClient(rawurl string, certFile string, keyFile string, certFiles []string) (client *WhisperClient, _ error) {
	rawClient, err := shhclient.Dial(rawurl, certFile, keyFile, certFiles)
