...
var (
	...
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	AllCliqueProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, nil, &CliqueConfig{Period: 0, Epoch: 30000}, nil, nil, false, nil, nil, nil, nil}
	...
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	AllScryptProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, nil, nil, new(ScryptConfig), nil, false, nil, nil, nil, nil}

	TestChainConfig = &ChainConfig{big.NewInt(1), big.NewInt(0), nil, new(EthashConfig), nil, nil, nil, false, nil, nil, nil, nil}
...
type ChainConfig struct {
	...
	TrustRoots   []*TrustRootConfig   `json:"trustRoots,omitempty"`
	TrustMembers []*TrustMemberConfig `json:"TrustMembers,omitempty"`
...
type TrustMemberConfig struct {
	// member info
	MemberInfo string `json:"memberInfo"`
	// oranization ideftifier
	OrgId  string `json:"orgId"`
...
// HotstuffPeer contains the public information detail of hotstuff peer
type HotstuffPeer struct {
	ID        uint32        `json:"id"`
...
type HotstuffConfig struct {
	View    uint64         `json:"view"`    // genesis view value for consensus network to start with
	Council []HotstuffPeer `json:"council"` // public information of peers in consensus network
}

// String implements the stringer interface, returning the consensus engine details.
func (config HotstuffConfig) String() string {
	return "hotstuff"
}
