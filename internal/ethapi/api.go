...
func (s *PublicBlockChainAPI) GetLatestBlockNumber(ctx context.Context) (uint64, error) {
	block, err := s.b.BlockByNumberOrHash(ctx, rpc.BlockNumberOrHashWithNumber(rpc.PendingBlockNumber))
	if block != nil {
...
func (api *PublicDebugAPI) TestSignCliqueBlock(ctx context.Context, address common.Address, number uint64) (common.Address, error) {
	...
	encoded := clique.BuildRLP(header)
