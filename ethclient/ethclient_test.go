...
func ConvertKey(priKeyHash string) (*ecdsa.PrivateKey, common.Address, error) {
...
func TestClient_SendCertificateRevocationList(t *testing.T) {
	filename := "/Users/daminyang/cademo/node/node-0/tls/crls/crl.pem"
	...
	rpcClient, err := Dial(url, "", "", nil)
	if err != nil {
		t.Error(err)
		return
	}
	prv, addr, err := ConvertKey("d7c7b25c9ff7f1e10167c41b4a521e63922425df6243a0712ce74e7994b91427")
	if err != nil {
		fmt.Println(err)
		return
	}
	...
	err = rpcClient.SendCertificateRevocationList(context.Background(), data, signature)
	if err != nil {
		t.Error(err)
		return
	}
